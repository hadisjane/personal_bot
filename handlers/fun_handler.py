    ...
    async def handle_meme(self, event):
        ...
        try:
            ...
            memes = [
                ...
                "Всё по кайфу 😎",
                "А теперь серьезно",
                "В голове только бабки и еда",
                "А если серьезно, я пошутил",
                "Обалдеть, ё-моё! 😱",
                "Чёт зашкварился, братан 🥴",
                "Просто охуеть",
                "На все руки мастер",
                "От души, братан! 🤜🤛",
                "Без комментариев",
                ...
                "Против системы",
                "Превед, медвед! 🐻",
                "Ты кто такой? Давай, до свидания! ✌️",
                "Не, это не баг — это фича! 🐞",
                "Печалька... 😢",
                "Котик в тапках 🐱👟",
                "42, братуха! 🔢",
                ...
                "А ниче тот факт, что... 🤔",
                "Всё пропало! 🔥",
                "Говоришь, да не говоришь... 🤐",
                "Вписка удалась! 🎉",
                "Капитан Очевидность 🚩",
                "Нормально, нормально... ну так себе... 😅",
                "У меня всё под контролем 🤡",
                "Пальцем в небо 🎯",
                "Кто тут чемпион? 🏆",
                "Пацан к успеху шёл... и заблудился 😵‍💫",
                "Живём один раз! 🎉",
                "Легенда интернета 📜",
                "Жизнь — это боль, братан 😤",
                "Бомба замедленного действия 💣",
                "Ты мне не друг, ты мне враг! ⚔️",
                "Сделай мне кофе ☕",
                "Как так вышло? 🤷‍♂️",
                "Забей, бывает... 😔",
                "Лечу в тапках на работу 🛫👟",
                "Круче не бывает 🔥",
                "Все проблемы решаются пивом 🍺",
                "Давай уже спать! 😴",
                "Время — деньги ⏳💰",
                "Слишком умён для этого мира 🤓",
                "Отвали, я занят! 🚫",
